...
import { LogInIcon, UserIcon, Linkedin, Twitter, Facebook, Github, Instagram, Youtube, Globe, MessageCircle } from 'lucide-react';
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <div className="mt-4 flex flex-wrap gap-4">
                ...
                <a href="https://discord.gg/j9DggrBV" aria-label="Discord" target="_blank" rel="noopener noreferrer">
            ...
            <div className="col-span-12 md:col-span-6 ml-auto grid grid-cols-3 gap-4">
              ...
              <div className="flex flex-col gap-y-2.5">
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="https://divisioncero.com/home/empresas?utm_source=docs.divisioncero.com/docs/kudo" className="text-sm hover:underline" target="_blank" rel="noopener noreferrer">Ciberseguridad Empresarial</a></li>
              ...
              <div className="flex flex-col gap-y-2.5">
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="https://divisioncero.com/trust-center?utm_source=docs.divisioncero.com/docs/kudo" className="text-sm hover:underline" target="_blank" rel="noopener noreferrer">Centro de Confianza</a></li>
                </ul>
              </div>
            </div>
          </div>
