...
1. Revisa los [estándares OSCAL de NIST](https://pages.nist.gov/OSCAL/?utm_source=docs.divisioncero.com/docs/kudo)
2. Consulta nuestro [repositorio en GitHub](https://github.com/PetterVargas/divisioncero-docs?utm_source=docs.divisioncero.com/docs/kudo)
