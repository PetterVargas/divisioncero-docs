...
**Subversion (SVN):** Solo para proyectos legacy en proceso de migración
**Perforce:** Para assets binarios grandes (diseño, multimedia)
...
**RTO (Recovery Time Objective):** 4 horas para repositorios críticos
